<template>
	<view>
		<view class="ttt">
			<view class="Regis_icon">
				<image src="../../static/icon/info/icon-shop.png"></image>
			</view>
		</view>
		<view class="Regis_info">
			<view class="Regis_t">
				<view class="mid-input">
					<!-- <image src="../../static/icon/index/main/我的.png"></image> -->
					<input type="text" placeholder="请输入手机号" :value="S_num" @input="changeNum"/>
				</view>
			</view>
			<view class="Regis_t" style="display: flex; align-items: center;">
				<view class="mid-input" style="width: 330rpx; margin-left: 5rpx;">
					<!-- <image src="../../static/icon/info/昵称.png" style="width: 53rpx; height: 53rpx;"></image> -->
			...
			<view class="Regis_t">
				<view class="mid-input">
					<!-- <image src="../../static/icon/info/密码.png" ></image> -->
					<input type="text" placeholder="密码" password="ture" @input="changepwd"/>
				</view>
			</view>
			<view class="Regis_t">
				<view class="mid-input">
					<!-- <image src="../../static/icon/info/密码.png" ></image> -->
					<input type="text" placeholder="请再次输入密码" password="ture" @input="changerpwd"/>
				</view>
			</view>
<!-- 			<view class="Regis_t">
				<view class="mid-input">
					<image src="../../static/icon/info/安全.png"></image>
...
<!-- 			<view class="Regis_t">
				<view class="mid-input">
					<image src="../../static/icon/info/抢答答案.png" ></image>
			...
			<uni-popup ref="popupMss" type="center">
				 <view class="popMess">
				 	请重新输入确认密码！
				 </view>
			</uni-popup>
...
<script>
	export default {
		...
		methods:{
			...
			changeNum(e){
				this.S_num = e.target.value
			},
			changepass(e){
				this.S_nvalue = e.target.value
			},
			changepwd(e){
				this.S_npwd = e.target.value
			},
			changerpwd(e){
				this.S_nrpwd = e.target.value
			},
			changeaddr(e){
				this.S_naddr = e.target.value
			},
			checkNum(){
				if (!/^1[34578]\d{9}$/.test(this.S_num)){
			...
			postnum(){
				if(this.S_nvalue != this.S_getn)
				{
					this.$refs.popupMass.open();
				}
				if(this.S_npwd != this.S_nrpwd)
				{
...
<style lang="scss" scoped>
	...
	.butt_regis{
		...
		button{
			...
			width: 360rpx;
			// color: #FFFFFF;
			background:linear-gradient(to right, rgba(255, 190, 118, 1.0), rgba(255, 204, 37, 1.0));
		}
	}
</style>
