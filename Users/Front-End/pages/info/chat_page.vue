<template>
	<view>
		...
		<view class="chat_info">
			<scroll-view scroll-y=true style="height: 1075rpx;">
				<chat_it :value="item" v-for="(item,index) in chat_mesg" :key=index :contents="item"></chat_it>
			</scroll-view>
		</view>
		<!-- 输入框 -->
		<view class="input_part" style="height: 100rpx;">
...
<script>
		import chat_it from '../../components/uni-deli/chat_item.vue'
	export default {
		data() {
			return {
				chat_mesg:[],
		...
		methods:{
			...
			changeinput(){ uni.setStorageSync('isinput',false)}
	},
	onLoad() {
